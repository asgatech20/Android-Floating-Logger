...
public abstract class StandOutWindow extends Service {
    ...
    public Notification getPersistentNotification(int id) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(c, "Asgatech_Logger_Channel");
    ...
    private void startMyOwnForeground() {
        String NOTIFICATION_CHANNEL_ID = "Asgatech_Logger_Channel";
        String channelName = "Asgatech_Logger_Channel";
        ...
        Notification notification = notificationBuilder.setOngoing(true)
                .setSmallIcon(R.drawable.asga_logo)
                .setContentTitle("Asgatech Logger is running in background")
